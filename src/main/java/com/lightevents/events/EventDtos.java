...
public final class EventDtos {
    ...
    public record TicketHolder(String fullName, @Email String email, String phone, String whatsapp) {}
    public record ReserveTicketsRequest(@NotBlank String buyerName, @Email String buyerEmail, String buyerPhone, String buyerWhatsapp, boolean companyPurchase, String companyName, @NotNull Long ticketTypeId, @Min(1) int quantity, List<TicketHolder> holders) {}
