...
public class AccountService {
    ...
    public Account register(AuthDtos.RegisterRequest r){
        ...
        a.setRole(r.role()==null?AccountRole.PARTICIPANT:r.role());
    ...
    public Account requireVerified(String token){
        ...
        Account a = accounts.findByApiToken(token.replace("Bearer ","")).orElseThrow(() -> new ApiException(HttpStatus.UNAUTHORIZED,"Invalid token"));
