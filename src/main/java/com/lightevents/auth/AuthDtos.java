...
public final class AuthDtos {
    ...
    public record LoginStartResponse(String email, String message, String codePreview) {}
    public record AccountResponse(Long id, String fullName, String email, String phone, AccountRole role, boolean verified, String apiToken, String codePreview, String message) {}
}
